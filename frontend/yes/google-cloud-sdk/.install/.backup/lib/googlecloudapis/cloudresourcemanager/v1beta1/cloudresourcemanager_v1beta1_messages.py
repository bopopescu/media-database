...
class CloudresourcemanagerProjectsProhibitselfremovalfromownersRequest(_messages.Message):
  """A CloudresourcemanagerProjectsProhibitselfremovalfromownersRequest
  object.
...
class ProhibitSelfRemovalFromOwnersResponse(_messages.Message):
  """A ProhibitSelfRemovalFromOwnersResponse object.

  Fields:
    shouldProhibit: A boolean attribute.
  """

  shouldProhibit = _messages.BooleanField(1)
