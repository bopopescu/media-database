  ...
  class ProjectsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      ...
      self._method_configs = {
          ...
          'Prohibitselfremovalfromowners': base_api.ApiMethodInfo(
              http_method=u'POST',
              method_id=u'cloudresourcemanager.projects.prohibitselfremovalfromowners',
              ordered_params=[u'projectId'],
              path_params=[u'projectId'],
              query_params=[],
              relative_path=u'v1beta1/projects/{projectId}:prohibitselfremovalfromowners',
              request_field='',
              request_type_name=u'CloudresourcemanagerProjectsProhibitselfremovalfromownersRequest',
              response_type_name=u'ProhibitSelfRemovalFromOwnersResponse',
              supports_download=False,
          ),
...
New projects do not necessarily appear at the end of the list.
    ...
    def Prohibitselfremovalfromowners(self, request, global_params=None):
      """Determine whether self-removal from owners should be prohibited.
for the user.  This method is for INTERNAL only, and for stop-gap
tactical usage.
TODO(user): Delete this once b/21331973 is resolved.

      Args:
        request: (CloudresourcemanagerProjectsProhibitselfremovalfromownersRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ProhibitSelfRemovalFromOwnersResponse) The response message.
      """
      config = self.GetMethodConfig('Prohibitselfremovalfromowners')
      return self._RunMethod(
          config, request, global_params=global_params)
