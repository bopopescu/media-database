...
class ListMessages(base.Command):
  ...
  def Run(self, args):
    ...
    importance_enum = (
        dataflow_messages.DataflowV1b3ProjectsJobsMessagesListRequest
    ...
    request = dataflow_messages.DataflowV1b3ProjectsJobsMessagesListRequest(
  ...
  def _GetMessages(self, apitools_client, request):
    return list_pager.YieldFromList(
        apitools_client.v1b3_projects_jobs_messages,
        request,
