...
class DataflowV1b3ProjectsJobsCreateRequest(_messages.Message):
...
class DataflowV1b3ProjectsJobsGetMetricsRequest(_messages.Message):
...
class DataflowV1b3ProjectsJobsGetRequest(_messages.Message):
...
class DataflowV1b3ProjectsJobsListRequest(_messages.Message):
...
class DataflowV1b3ProjectsJobsMessagesListRequest(_messages.Message):
...
class DataflowV1b3ProjectsJobsPatchRequest(_messages.Message):
...
class DataflowV1b3ProjectsJobsUpdateRequest(_messages.Message):
...
class DataflowV1b3ProjectsJobsWorkItemsLeaseRequest(_messages.Message):
...
class DataflowV1b3ProjectsJobsWorkItemsReportStatusRequest(_messages.Message):
...
class Environment(_messages.Message):
  ...
  sdkPipelineOptions = _messages.MessageField('SdkPipelineOptionsValue', 4)
  tempStoragePrefix = _messages.StringField(5)
  userAgent = _messages.MessageField('UserAgentValue', 6)
  version = _messages.MessageField('VersionValue', 7)
  workerPools = _messages.MessageField('WorkerPool', 8, repeated=True)
...
class StreamLocation(_messages.Message):
  ...
  pubsubLocation = _messages.MessageField('PubsubLocation', 1)
  sideInputLocation = _messages.MessageField('StreamingSideInputLocation', 2)
  streamingStageLocation = _messages.MessageField('StreamingStageLocation', 3)
