...
class Table(_messages.Message):
  ...
  numBytes = _messages.IntegerField(9)
  numRows = _messages.IntegerField(10, variant=_messages.Variant.UINT64)
  schema = _messages.MessageField('TableSchema', 11)
  selfLink = _messages.StringField(12)
  tableReference = _messages.MessageField('TableReference', 13)
  type = _messages.StringField(14)
  view = _messages.MessageField('ViewDefinition', 15)
