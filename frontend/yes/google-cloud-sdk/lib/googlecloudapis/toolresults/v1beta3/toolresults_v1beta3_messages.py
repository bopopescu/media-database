...
class Step(_messages.Message):
  ...
  testExecutionStep = _messages.MessageField('TestExecutionStep', 11)
  toolExecutionStep = _messages.MessageField('ToolExecutionStep', 12)
...
class ToolresultsProjectsHistoriesListRequest(_messages.Message):
  ...
  Fields:
    filterByDisplayName: If set, only return histories with the given display
      name.  Optional.
  ...
  filterByDisplayName = _messages.StringField(1)
  pageSize = _messages.IntegerField(2, variant=_messages.Variant.INT32)
  pageToken = _messages.StringField(3)
  projectId = _messages.StringField(4, required=True)
